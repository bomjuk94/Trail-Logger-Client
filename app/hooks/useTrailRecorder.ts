...
//         })();
//         return () => {
//             if (active && Platform.OS !== 'web') deactivateKeepAwake('trail-recorder');
//         };
//     }, [status]);
...
//         if (!uid) {
//             setStatus('idle');
//             return showToast({ type: "error", msg: "Could not save hike, please log in and try again." });
//         }
